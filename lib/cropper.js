...
(function (Carbon) {
    ...
    var Viewport = (function () {
        ...
        Viewport.prototype.setOffset = function (offset) {
            ...
            var distanceToRightEdge = (size.width - this.width) + (offset.left * this.content.scale);
            if (distanceToRightEdge < 0) {
                offset.left = -((size.width - this.width) / this.content.scale);
            }
            var distanceToBottomEdge = size.height - this.height + (offset.top * this.content.scale);
